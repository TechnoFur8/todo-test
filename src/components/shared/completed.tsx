...
export const Completed = ({ setActiveTab, activeTab }: Props) => {
            ...
            <AccordionItem value="1">
                ...
                <div className={"flex items-center justify-between bg-white shadow py-2 border-t-zinc-300 border-1 px-3"}>
                    ...
                    <div className={"space-x-2"}>
                        ...
                        <Button variant={"link"} className={cn("cursor-pointer text-zinc-400 font-normal", activeTab === "COMPLITED" && "underline")} onClick={() => setActiveTab("COMPLITED")}>Completed</Button>
                    </div>
